    ...
    <script>
        $(function () {
            ...
            var gridDataSource = new DevExpress.data.DataSource({
                ...
                loadMode: "raw",
                load: function () {
                    return $.getJSON("<%=contextPath%>/Certificate/GetAll");
                },
                // 插入数据
                insert: function (values) {
                    return $.ajax({
                        url: "<%=contextPath%>/Certificate/Add/",
                        method: "POST",
                        data: values
                    })
                },
                ...
                remove: function (key) {
                    return $.ajax({
                        url: "<%=contextPath%>/Certificate/Delete/" + key,
                        method: "POST"
                    })
                },
                update: function (key, values) {
                    return $.ajax({
                        url: "<%=contextPath%>/Certificate/Edit/" + key,
                        method: "POST",
                        data: values
                    })
                }
